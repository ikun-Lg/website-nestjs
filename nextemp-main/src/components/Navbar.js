    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav className="flex items-center justify-center">
          ...
          <CustomLink className="mx-4" href="/about" title="关于我" />
          <CustomLink className="mx-4" href="/projects" title="项目" />
          <CustomLink className="ml-4" href="/articles" title="文章" />
        </nav>
        <nav
      ...
      "
        >
          ...
          <motion.a
            ...
            href="https://space.bilibili.com/495549604?spm_id_from=333.1007.0.0d"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            aria-label="Checkout my Bilibili"
          >
           <BilibiliIcon/>
          </motion.a>
